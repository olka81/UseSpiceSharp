...
namespace SpiceSharp.Components.BSIM3Behaviors
{
    ...
    public class ModelBaseParameters : ParameterSet
    {
        ...
        public GivenParameter<double> Lintnoi { get; } = new GivenParameter<double>();
        ...
        public GivenParameter<double> Xl { get; } = new GivenParameter<double>();
        [ParameterName("xw"), ParameterInfo("Width correction parameter")]
        public GivenParameter<double> Xw { get; } = new GivenParameter<double>();
        ...
        public GivenParameter<double> VgsMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vgd_max"), ParameterInfo("maximum voltage G-D branch")]
        public GivenParameter<double> VgdMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vgb_max"), ParameterInfo("maximum voltage G-B branch")]
        public GivenParameter<double> VgbMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vds_max"), ParameterInfo("maximum voltage D-S branch")]
        public GivenParameter<double> VdsMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vbs_max"), ParameterInfo("maximum voltage B-S branch")]
        public GivenParameter<double> VbsMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vbd_max"), ParameterInfo("maximum voltage B-D branch")]
        public GivenParameter<double> VbdMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vgsr_max"), ParameterInfo("maximum voltage G-S branch")]
        public GivenParameter<double> VgsrMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vgdr_max"), ParameterInfo("maximum voltage G-D branch")]
        public GivenParameter<double> VgdrMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vgbr_max"), ParameterInfo("maximum voltage G-B branch")]
        public GivenParameter<double> VgbrMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vbsr_max"), ParameterInfo("maximum voltage B-S branch")]
        public GivenParameter<double> VbsrMax { get; } = new GivenParameter<double>(1e+99);
        [ParameterName("vbdr_max"), ParameterInfo("maximum voltage B-D branch")]
        public GivenParameter<double> VbdrMax { get; } = new GivenParameter<double>(1e+99);
        ...
        public override void CalculateDefaults()
        {
            ...
            // Parameter set for Ngate (BSIM3ngate)
            if (Ngate > 1.0e23)
                Ngate.RawValue *= 1.0e-6;
            // Parameter set for Lnpeak (BSIM3lnpeak)
            if (Lnpeak > 1.0e20)
                Lnpeak.RawValue *= 1.0e-6;
            // Parameter set for Lngate (BSIM3lngate)
            if (Lngate > 1.0e23)
                Lngate.RawValue *= 1.0e-6;
            // Parameter set for Wnpeak (BSIM3wnpeak)
            if (Wnpeak > 1.0e20)
                Wnpeak.RawValue *= 1.0e-6;
            // Parameter set for Wngate (BSIM3wngate)
            if (Wngate > 1.0e23)
                Wngate.RawValue *= 1.0e-6;
            // Parameter set for Pnpeak (BSIM3pnpeak)
            if (Pnpeak > 1.0e20)
                Pnpeak.RawValue *= 1.0e-6;
            // Parameter set for Pngate (BSIM3pngate)
            if (Pngate > 1.0e23)
                Pngate.RawValue *= 1.0e-6;
            if (!NqsMod.Given)
                NqsMod.RawValue = 0;
            else if (NqsMod != 0 && NqsMod != 1)
            {
                NqsMod.RawValue = 0;
                CircuitWarning.Warning(this, "Warning: nqsMod has been set to its default value: 0.");
            }
            if (!AcnqsMod.Given)
                AcnqsMod.RawValue = 0;
            ...
            if (!Uc.Given)
                Uc.RawValue = MobMod == 3 ? -0.0465 : -0.0465e-9;
            if (!Uc1.Given)
                Uc1.RawValue = MobMod == 3 ? -0.056 : -0.056e-9;
            if (!U0.Given)
